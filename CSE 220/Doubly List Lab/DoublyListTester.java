public class DoublyListTester{
    public static void main(String [] args){
        ...
        // below codes are for the other tester classes of the assignment
        System.out.println("\n/////  Test 06  /////");
        Object [] a4 = {10,20,30,40,50,60,70};
        DoublyList h4 = new DoublyList(a3);
        Object elem = h4.getElem(4);
        System.out.println(elem); // this should print 50
        h4.setElem(100, 2);
        h4.forwardprint(); // this shold print 10 20 100 40 50 60 70
        h4.searchElem(70, 6); // this should print "Found"
        h4.searchElem(300, 2); // this should print "Not Found"
        h4.reverse();
        h4.forwardprint(); // this should print 70 60 50 40 100 20 10
        h4.backwardprint(); // this should print 10 20 100 40 50 60 70
    }
